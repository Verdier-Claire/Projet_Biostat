...
On change le taux en nombre :
```{r}
mort <- mutate(mort,nb.maladies.foie = (Maladies.Foie*PA)/1000)
model_maladie.foie<-glm(nb.maladies.foie ~ periode * sex * age,  offset = log(PA),  family = "poisson", data = mort)
