...
```{r}
model_maladie.foie<-glm(Maladies.Foie ~ periode * sex * age,  offset = log(PA), family = "poisson", data = mort)
model_maladie.foie
...
```{r}
model_mort.viol<-glm(Mort.Violente ~ periode * sex * age,  offset = log(PA), family = "poisson", data = mort)
model_mort.viol
